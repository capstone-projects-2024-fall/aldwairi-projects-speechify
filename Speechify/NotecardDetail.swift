        ...
        //favorit button
            Button(action: {
                ...
                HStack {
                    ...
                    Text(currentNotecard.favorite == true ? "Remove from Favorites" : "Add to Favorites")
                }
            }
            .padding()
            .padding(.bottom, 10)
...
//        NotecardDetail(notecard: Notecard(from: <#any Decoder#>, word: "", phonetic: "", favorite: true, audioPath: "", wordID: ""))
